...
const MyListings = () => {
  ...
  const fetchProducts = async () => {
    ...
    try {
      const res = await fetch(
        `https://pawmart-assignment-10-woad.vercel.app/addListing?email=${user.email}`
      );
  ...
  const handleDeleteOrderProduct = (_id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch(
          `https://pawmart-assignment-10-woad.vercel.app/addListing/${_id}`,
          {
            method: "DELETE",
          }
        )
  ...
  const handleAddListing = async (e) => {
    ...
    try {
      const res = await fetch(
        `https://pawmart-assignment-10-woad.vercel.app/addListing/${updateProduct._id}`,
        {
          method: "PATCH",
